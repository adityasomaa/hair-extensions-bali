    ...
    <div className="min-h-screen bg-[#0e0b09] text-[#f6efe6] selection:bg-[#c9a87c] selection:text-[#0e0b09]">
      ...
      <header className="sticky top-0 z-30 border-b border-white/5 bg-[#0e0b09]/85 backdrop-blur-md">
        <nav className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-5">
          <Link href="/design-1" className="leading-none">
      ...
      <Link
        href="/"
        className="fixed bottom-6 left-6 z-40 hidden rounded-full border border-white/10 bg-[#0e0b09]/80 px-3 py-1.5 text-[10px] uppercase tracking-widest text-[#8a7a66] backdrop-blur-md hover:text-[#c9a87c] md:inline-block"
      >
        ← All designs
      </Link>
